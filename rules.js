...
function set_lord_calendar_keep_exile(lord, turn) {
...
function count_lord_all_troops(lord) {
...
function do_levy_troops_from(here) {
...
function modify_supply(loc, supply, is_port_supply, report) {
    let here = get_lord_locale(game.command);
    let carts = count_shared_carts(here, true);
